                        ...
                        <ol className="space-y-6">
                            <li className="flex gap-4 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-500 mt-1">Initiate an analysis by selecting any point on our 3D globe. Our platform targets the precise coordinates for deep environmental assessment.</p>
                                </div>
                            </li>
